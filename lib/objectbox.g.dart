...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 151318351651190635),
      name: 'NoteModel',
      lastPropertyId: const obx_int.IdUid(5, 1456183008738441375),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8797537138500158489),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3702707013500918174),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 5222445979839270311),
            name: 'subtitle',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4469266845998324096),
            name: 'date',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 1456183008738441375),
            name: 'color',
            type: 6,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 151318351651190635),
...
class NoteModel_ {
  ...
  /// See [NoteModel.subtitle].
  static final subtitle =
      obx.QueryStringProperty<NoteModel>(_entities[0].properties[2]);

  /// See [NoteModel.date].
  static final date =
      obx.QueryStringProperty<NoteModel>(_entities[0].properties[3]);

  /// See [NoteModel.color].
  static final color =
      obx.QueryIntegerProperty<NoteModel>(_entities[0].properties[4]);
}
